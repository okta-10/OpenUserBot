...
async def amireallyalive(alive):
    ...
    output = (
                     ...
                     f"---------------------------------------\n"
                     f" Current Supported Devices: \n"
                     f"  - Redmi Note 5 Pro/AI (Whyred) \n"
                     f"  - Redmi Note 6 Pro (Tulip) \n"
                     f"  - Redmi Note 7 (Lavender) \n"
                     f"  - Mi 6x (Wayne) \n"
                     f"  - Mi A2 (Jasmine) \n"
                     f"---------------------------------------\n"
                     f" Dropped Devices: \n"
                     f"  - Redmi Note 8 (Ginkgo) \n"
                     f"  - Redmi Note 8T (Willow) \n"
                     f"  - Realmeme XT \n"
                     f"---------------------------------------\n"
                     f" Join Us: \n"
                     f"  - @MysticKernel \n"
                     f"  - @MysticKernelDiscussion \n"
                     f"---------------------------------------\n"
